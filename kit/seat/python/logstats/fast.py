...
def fast_level_counts(text: str) -> dict:
    ...
    successfully, and the pure-Python fallback otherwise. TODO(S3): call into `_LIB` and
    translate its `out5` array into this shape; for now this always uses the fallback."""
