...
def test_card_warnings_field_and_inversion_text():
    ...
    assert len(w) == 1 and w[0].startswith("profile gemma4-8b-e4b-q4km-vulkan serves qwen35-9b-q4km-vulkan's file (Qwen3.5-9B-Q4_K_M.gguf): A770B_GEMMA4_8B_E4B_Q4KM_VULKAN_MODEL comes from the environment or builder.env")
