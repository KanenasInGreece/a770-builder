...
| `compose/a770-vulkan.yaml` | an example Compose file for the same server in a container: official llama.cpp Vulkan image, GGUFs bind-mounted, PCI device nodes and group ids from the environment; passthrough unmeasured until a host brings it up |
