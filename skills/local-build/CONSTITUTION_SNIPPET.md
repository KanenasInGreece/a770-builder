...
<!-- profiles:begin -->
Display-safe (`A770B_CARD_MODE=display`, the default): **--profile qwen35-9b-q4km-vulkan** = Qwen3.5-9B-Q4_K_M, 262,144-token window (useful to ~65k), ~37 tok/s; **--profile gemma4-8b-e4b-q4km-vulkan** = gemma-4-E4B-Q4_K_M, 131,072-token window (useful to ~100k), ~60 tok/s; **--profile qwen38-27b-iq3xxs-vulkan** = Qwen3.8-27B-GSQ-RCO-IQ3_XXS, 131,072-token window (useful to ~32k), ~8 tok/s.
Pure-inference (`A770B_CARD_MODE=inference`, a card that draws no desktop): **--profile qwen35-9b-q4km-vulkan** = Qwen3.5-9B-Q4_K_M, 262,144-token window (useful to ~262k), ~29 tok/s; **--profile qwen38-27b-iq3s-vulkan** = Qwen3.8-27B-GSQ-RCO-IQ3_S, 196,608-token window (useful to ~98k), ~8 tok/s; **--profile qwen38-27b-iq3s-sycl** = Qwen3.8-27B-GSQ-RCO-IQ3_S, 100,000-token window (useful to ~100k), ~10 tok/s.
<!-- profiles:end -->
Call:
